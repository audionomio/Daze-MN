...
================================================= */
	...
	if ( have_posts() ) :	
		$layout_type = get_theme_mod( 'daze_custom_author_layout',  false ) ?
			get_theme_mod( 'daze_author_layout_type', 'tiny' ) :
			get_theme_mod( 'daze_blog_layout_type', 'masonry' );
		
		$layout_width = get_theme_mod( 'daze_custom_author_layout', false ) ?
			get_theme_mod( 'daze_author_layout_width', 'narrow' ) :
			get_theme_mod( 'daze_blog_layout_width', 'narrow' );
		
		$s = get_theme_mod( 'daze_custom_author_layout', false ) ?
			get_theme_mod( 'daze_author_include_sidebar', false ) :
...
?>
		<div class="archive-header-holder content-wrapper clearfix">
			<div class="archive-header post-header">
				<h6><?php esc_html_e( 'Author:', 'daze' ); ?></h6>
				<?php
				...
				<div class="post-meta"><?php echo esc_html( get_the_author_meta( 'description' ) ); ?></div>
			</div>
		</div>
